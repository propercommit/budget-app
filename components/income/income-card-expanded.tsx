        ...
        <div className="flex flex-col gap-4">
            ...
            {isEmpty ? (
                ...
                <>
                    ...
                    <button 
                        onClick={onAdd}
                        className="w-full py-4 px-6 rounded-2xl border-2 border-dashed border-border flex items-center justify-center gap-2 hover:border-blue-500 hover:bg-blue-50 transition-colors"
                    >
